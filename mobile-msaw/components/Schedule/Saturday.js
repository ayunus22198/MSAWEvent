          ...
          {(events != null) ? events.map((e, i) => {
            if(!e.selectable) {
              ...
              if(this.returnIfIncluded(e) != -1) {
                return <Block selectable = {true} key = {i}  navigateFront = {true} allEvents = {e.events} e = {e.events[this.returnIfIncluded(e)]}/>
              } else {
...
export default connect(mapStateToProps, { fetchEvents })(Saturday);
